            ...
            >
              ...
              >
                <CardMedia
                  ...
                  sx={{
                    height: 200,
                    backgroundImage: previewImages.official
                      ? `url(${previewImages.official})`
                      : 'linear-gradient(45deg, #ff6b9d, #ff8cc8)',
            ...
            >
              ...
              >
                <CardMedia
                  ...
                  sx={{
                    height: 200,
                    backgroundImage: previewImages.anime
                      ? `url(${previewImages.anime})`
                      : 'linear-gradient(45deg, #ff8cc8, #ffb3d9)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    display: 'flex',
                    alignItems: 'center',
            ...
            >
              ...
              >
                <CardMedia
                  ...
                  sx={{
                    height: 200,
                    backgroundImage: previewImages.wallpaper
                      ? `url(${previewImages.wallpaper})`
                      : 'linear-gradient(45deg, #ffb3d9, #ffc9e6)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    display: 'flex',
                    alignItems: 'center',
            ...
            >
              ...
              >
                <CardMedia
                  ...
                  sx={{
                    height: 200,
                    backgroundImage: previewImages.fanart
                      ? `url(${previewImages.fanart})`
                      : 'linear-gradient(45deg, #ffc9e6, #ffe0f0)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    display: 'flex',
                    alignItems: 'center',
